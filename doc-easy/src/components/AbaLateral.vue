<template>
  ...
  <v-navigation-drawer permanent expand-on-hover rail>
    <!-- <v-list>
      <v-list-item prepend-avatar="https://randomuser.me/api/portraits/men/85.jpg" title="David Rusycki" subtitle="davidrusyck@gmail.com"></v-list-item>
    </v-list> -->

    <v-divider></v-divider>

    <v-list density="compact" nav>
      <v-list-item @click="overlay = true" prepend-icon="mdi-folder" title="Plano de documentos" value="planodedocumentos" :href="'/planos'"></v-list-item>
